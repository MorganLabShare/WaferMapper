...
for i = 1:MaxLabelNum
    ...
    DSFactor = ceil(TempWidth/256); %ceil(TempWidth/256);%ceil(TempWidth/512);%Note: this will always make sure that the max image size to the alignment routine is 512x512
    %DSFactor = 8;
